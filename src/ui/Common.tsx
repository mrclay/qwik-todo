...
export const H1 = component$<CNProps>(({
  moreClass = "",
}) => (
  <h1 class={`h2 ${moreClass}`}><Slot /></h1>
));

export const Content900 = component$<CNProps>(({
  moreClass = "",
}) => (
...
export const Container900 = component$<CNProps>(({
  moreClass = "",
}) => (
  <div class={`mx-auto max-width-900 ${moreClass}`}><Slot /></div>
));
